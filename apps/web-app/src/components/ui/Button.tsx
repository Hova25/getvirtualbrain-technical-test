...
const buttonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      secondary: 'text-gray-800 bg-amber-300 hover:bg-amber-400 disabled:bg-amber-100',
      tertiary: 'border border-gray-300 bg-white hover:bg-gray-100 dark:bg-gray-800 hover:dark:bg-gray-700'
    },
  },
  defaultVariants: {
    variant: 'primary'
